...
class TheMoak_Tryon_Products {
    ...
    /**
     * AJAX handler to get product adjustment settings
     */
    public function ajax_get_product_adjustments() {
        ...
        wp_send_json_success($adjustment_fields);
        exit;
    }

    /**
     * AJAX handler to save product adjustment settings
     */
    public function ajax_save_product_adjustments() {
        // Check security
        check_ajax_referer('themoak_save_adjustments', 'themoak_adjustment_nonce');
